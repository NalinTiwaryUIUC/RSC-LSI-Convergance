...
Runs discovered: **4** in `experiments/runs` (glob `w2_*_T100000_*ul_initI2_step2475_chain*`)
...
|-------|----------|-------------|-------------|----------|----------|---------------------|-------------------|----------|----------------|
| f_nll | 2.1096 | 2.4105 | 3.4105 | 5.0082 | 15.5062 | 0.2499 | 99960 | 20.0407 | 50.1017 |
| f_margin | 1.1539 | 1.6993 | 2.6081 | 9.7487 | 29.7538 | 0.2499 | 99960 | 39.0103 | 97.5257 |
| f_dist | 0.9998 | 3.1992 | 3.2008 | 6.0884 | 62.7937 | 0.2499 | 99960 | 24.3635 | 60.9088 |
| dist_to_ref_sq_over_d | 0.9998 | 3.1992 | 3.2008 | 6.0884 | 62.7937 | 0.2499 | 99960 | 24.3635 | 60.9088 |
| dist_to_ref_over_sqrt_d | 0.9998 | 3.6545 | 3.6566 | 6.0884 | 62.7937 | 0.2499 | 99960 | 24.3635 | 60.9088 |
| dist_to_ref_over_ou_radius | 0.9998 | 3.6545 | 3.6566 | 6.0884 | 62.7937 | 0.2499 | 99960 | 24.3635 | 60.9088 |
| f_proj1 | 3.8942 | 3.5092 | 4.0323 | 4.3664 | 12.0527 | 0.2499 | 99960 | 17.4727 | 43.6817 |
| f_proj2 | 3.2632 | 6.6859 | 8.6269 | 4.3791 | 11.3895 | 0.2499 | 99960 | 17.5232 | 43.8081 |
| f_pc1 | 1.6315 | 1.7864 | 3.3402 | 6.0858 | 11.6133 | 0.2499 | 99960 | 24.3529 | 60.8823 |
| f_pc2 | 1.4682 | 2.0139 | 2.3498 | 5.3050 | 11.3865 | 0.2499 | 99960 | 21.2283 | 53.0708 |

#### Last **25%** of saved samples per chain

| probe | R̂ (late) | drift_z mean | drift_z max | ESS_bulk | ESS_tail | T_analysis (phys) | grad evals (span) | ESS/T_phys | ESS/(1e6 grad) |
|-------|----------|-------------|-------------|----------|----------|---------------------|-------------------|----------|----------------|
| f_nll | 4.0917 | 0.4002 | 0.5229 | 5.3512 | 25.9867 | 0.1249 | 49960 | 42.8439 | 107.11 |
| f_margin | 1.9254 | 0.9045 | 1.6401 | 5.8682 | 18.2294 | 0.1249 | 49960 | 46.9833 | 117.458 |
| f_dist | 0.9996 | 3.3580 | 3.3600 | 6.0966 | 63.1082 | 0.1249 | 49960 | 48.8119 | 122.03 |
| dist_to_ref_sq_over_d | 0.9996 | 3.3580 | 3.3600 | 6.0966 | 63.1082 | 0.1249 | 49960 | 48.8119 | 122.03 |
| dist_to_ref_over_sqrt_d | 0.9996 | 3.5548 | 3.5571 | 6.0966 | 63.1082 | 0.1249 | 49960 | 48.8119 | 122.03 |
| dist_to_ref_over_ou_radius | 0.9996 | 3.5548 | 3.5571 | 6.0966 | 63.1082 | 0.1249 | 49960 | 48.8119 | 122.03 |
| f_proj1 | 8.8297 | 3.4506 | 4.1238 | 4.3001 | 11.4093 | 0.1249 | 49960 | 34.4283 | 86.0709 |
| f_proj2 | 12.9620 | 4.9846 | 8.3673 | 4.3645 | 11.4093 | 0.1249 | 49960 | 34.9443 | 87.3607 |
| f_pc1 | 1.6851 | 4.1825 | 8.1491 | 4.8726 | 11.4093 | 0.1249 | 49960 | 39.0122 | 97.5304 |
| f_pc2 | 1.2610 | 2.1507 | 4.3939 | 6.9384 | 11.4093 | 0.1249 | 49960 | 55.5516 | 138.879 |
